function [x,Out]=My_AmRBKU(A,b,ell,opts)

% Adaptive stochastic heavy ball momentum for solving linear systems
%              Ax=b
% we use the uniform sampling strategy
% and now the ASHBM leads to the RBKU with adaptive momentum  (AmRBKU)
%
...
%%%% setting the tolerance for stopping rule
...
%%% normized the row of the matrix A
